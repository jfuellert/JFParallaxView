Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       JFParallaxView is used as a class category for adding parallax to scrollable UIKit components.
                       DESC
  ...
  s.source_files     = 'JFParallaxView/Parallax View/**/*.{h,m}'
  s.public_header_files = 'JFParallaxView/Parallax View/**/*.{h}'
